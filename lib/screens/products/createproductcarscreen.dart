    ...
    if (currentUser?.id != null) {
      carProducts.add(
        ProductCar(
          ...
          engineCC: int.tryParse(_carEngineCCController.text)!,
          fuelType: _carFuelTypeController.text,
          mileage: int.tryParse(_carMileageController.text)!,
          ...
          yearOfManufacture: int.tryParse(_yearOfManufactureController.text)!,
